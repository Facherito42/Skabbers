...
function mount(){
  ...
  if (featured) featured.innerHTML = [PRODUCTS[0], PRODUCTS[1], PRODUCTS[2], PRODUCTS[3], PRODUCTS[4]].map(renderCard).join("");
...
function initNewsletter(){
  ...
  form.addEventListener("submit", (e) => {
    e.preventDefault();
    note.textContent = "Gracias. Te llega en la próxima edición.";
    form.reset();
  });
}
